	...
	public function borrarArticuloController(){
		...
		if(isset($_GET["idBorrar"])){
			...
			if($respuesta == "ok"){
					...
					function(isConfirm){
							 if (isConfirm) {
						  cancelButtonText: "No, cancelar!",unlink($_GET["rutaImagen"]);
						  <?php $datosController = $_GET["idBorrar"];$respuesta = GestorArticulosModel::borrarArticuloModel($datosController, "articulos");?>
