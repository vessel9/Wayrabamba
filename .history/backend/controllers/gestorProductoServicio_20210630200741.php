			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<div>
						...
						<form method="post" enctype="multipart/form-data">
							<input name="nombreProductoServicio" type="text" placeholder="Nombre producto" class="form-control" value="'.$item["nombreProductoServicio"].'" required>
							<div id="arrastreImagenProductoServicio"></div>	
							<input name="descripcion" type="text" placeholder="descripcion" class="form-control" value="'.$item["nombreProductoServicio"].'"required>
							<input name="precio" type="text" placeholder="precio" class="form-control" value="'.$item["nombreProductoServicio"].'"required>
							<input name="cantidad" type="text" placeholder="cantidad" class="form-control" value="'.$item["nombreProductoServicio"].'"required>
							<input name="disponibles" type="text" placeholder="disponibles" class="form-control" value="'.$item["nombreProductoServicio"].'" required>';
							...
							$mostrarProductoServicio -> mostrarProductoServicioController7();	
							 echo '<input type="submit" id="actualizarProductoServicio" value="Actualizar Productoservicio" class="btn btn-primary">
						</form>
					</div>
