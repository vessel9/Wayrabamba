			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
				...
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					...
					echo '<div class="modal-body">
					    ...
					    <label id="titulosModal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nombre del Producto</label>
					    <input id="editarUbicacion" name="editarNombreProductoServicio" type="text" placeholder="Nombre producto" class="form-control" value="'.$item["nombreProductoServicio"].'" required>
						</div>
						<div class="form-group">
						<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Descripción</label>
						<input id="editarUbicacion" name="editarDescripcion" type="text" placeholder="descripcion" class="form-control" value="'.$item["descripcion"].'"required>
						</div>
						<div class="form-group">
						<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Precio</label>
						<input id="editarUbicacion" name="editarPrecio" type="text" placeholder="precio" class="form-control" value="'.$item["precio"].'"required>
						</div>
						<div class="form-group">
						<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cantidad</label>
						<input id="editarUbicacion" name="editarCantidad" type="text" placeholder="cantidad" class="form-control" value="'.$item["cantidad"].'"required>
						</div>
						<div class="form-group">
						<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Disponibilidad</label>
						<input id="editarUbicacion" name="editarDisponibles" type="text" placeholder="disponibles" class="form-control" value="'.$item["disponibles"].'" required></div>';
