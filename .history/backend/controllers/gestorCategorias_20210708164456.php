...
class GestorCategorias{
	...
	public function mostrarCategoriasController(){
		...
		foreach($respuesta as $row => $item) {
			...
			<a href="index.php?action=tipoproductoservicio&idBorrarTipo='.$item["idCategoria"].'"><i class="fa fa-times btn btn-danger"></i></span></a></td>
		  </tr>
		   <div id="tipo'.$item["idCategoria"].'" class="modal fade">
				   <div class="modal-dialog modal-content">
					...
					<div class="modal-body" style="border:1px solid #eee">
						<form style="padding:0px 10px" method="post" enctype="multipart/form-data">
							  <input name="idTipoProductoServicio" type="hidden" value="'.$item["idCategoria"].'">
