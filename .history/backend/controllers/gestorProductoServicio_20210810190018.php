			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
				...
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					...
					echo '<div class="modal-body">
					    ...
					    <input name="editarNombreProductoServicio" type="text" placeholder="Nombre producto" value="'.$item["nombreProductoServicio"].'" required>
						</div>
						<div class="form-group">
						<label id="titulosModal"> Descripción</label>
						<input name="editarDescripcion" type="text" placeholder="descripcion"  value="'.$item["descripcion"].'"required>
						</div>
						<div class="form-group">
						<label id="titulosModal"> Precio</label>
						<input name="editarPrecio" type="text" placeholder="precio" value="'.$item["precio"].'"required>
						</div>
						<div class="form-group">
						<label id="titulosModal"> Cantidad</label>
						<input name="editarCantidad" type="text" placeholder="cantidad"  value="'.$item["cantidad"].'"required>
						</div>
						<div class="form-group">
						<label id="titulosModal"> Disponibilidad</label>
						<input name="editarDisponibles" type="text" placeholder="disponibles"  value="'.$item["disponibles"].'" required></div>';
