			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<div>
						...
						<form method="post" enctype="multipart/form-data">
							<div id="editarImagen"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default"><div id="nuevaFoto"><span class="fa fa-times cambiarImagen"></span><img src="" class="img-thumbnail"></div></div><input type="hidden" value=$ruta name="fotoAntigua">
