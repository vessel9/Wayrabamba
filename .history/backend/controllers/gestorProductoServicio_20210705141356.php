	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					echo '<div="agregarproductoservicio'.$item["idproductoServicio"].'"><div id="editarImagen"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default">
					<div id="nuevaFoto">
					<span class="fa fa-times cambiarImagen"></span>
					<img src="'.$item8["imagenRuta"].'"  class="img-thumbnailb">
					</div></div></div>';
					}
