	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<div id="nuevaFoto">
					<span class="fa fa-times cambiarImagen" id="agregarproductoservicio'.$item["idproductoServicio"].'">
				...
				<button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<input style="width:10%; padding:5px 0; margin-top:4px" id="actualizarProductoServicio" type="submit" class="btn btn-primary pull-right" value="Guardar">
