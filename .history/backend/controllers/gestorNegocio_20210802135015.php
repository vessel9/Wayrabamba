	...
	public function mostrarNegociosController(){
		...
		foreach($respuesta as $row => $item) {
			...
			<li class="card" id="'.$item["idNegocio"].'" class="bloqueArticulo" style="max-width:100%;width:800;height:400;">
					...
					<label><spam class="fa fa-whatsapp fa-lg" aria-hidden="true"></spam>Telefono:</label>
				    </div>
				    <div class="col-xs-9 col-sm-9 col-md-9">
				    <p>'.$item["telefono"].'</p>
				    </div>
					<div class="col-xs-3 col-sm-3 col-md-3">
					<label><spam class="fa fa-whatsapp fa-lg" aria-hidden="true"></spam> WhatsApp:</label>fa fa-phone-square
				    </div>
					<div class="col-xs-9 col-sm-9 col-md-9">
