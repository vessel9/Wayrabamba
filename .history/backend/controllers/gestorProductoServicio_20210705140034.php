...
class GestorProductoServicio{
	...
	public function mostrarProductoServicioController(){
		...
		$respuesta = GestorProductoServicioModel::mostrarProductoServicioModel2("productoservicio", "negocio", "tipoproductoservicio")
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
				...
				<button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<div id="nuevaFoto">
					<span class="fa fa-times cambiarImagen" id="editarImagen"></span>
