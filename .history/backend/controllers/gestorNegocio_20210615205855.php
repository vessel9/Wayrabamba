...
class GestorNegocio{
	...
	public function guardarNegocioController(){
		...
		if(isset($_POST["tituloNegocio"])){
			...
			$respuesta = GestorNegocioModel::guardarNegocioController($datosController, "negocio");
	...
	public function mostrarNegociosController(){
		...
		$respuesta = GestorNegocioModel::mostrarNegociosController("articulos");	
	

		foreach($respuesta as $row => $item) {

			echo ' <li id="'.$item["id"].'" class="bloqueNegocio">
	...
	public function editarNegocioController(){
		...
		if(isset($_POST["editarTitulo"])){
			...
			$respuesta = GestorNegocioModel::editarNegocioModel($datosController, "articulos");
