			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<button type="button" class="close" data-dismiss="modal">&times;</button>
						<form method="post" enctype="multipart/form-data">
							...
							<img src="'.$item["imagenRuta"].'" class="img-thumbnail"></div></div>
							<input type="hidden" name="editarNombreProductoServicio" type="text" placeholder="Nombre producto" class="form-control" value="'.$item["nombreProductoServicio"].'" required>
							<input type="hidden" name="editarDescripcion" type="text" placeholder="descripcion" class="form-control" value="'.$item["descripcion"].'"required>
							<input type="hidden" name="editarPrecio" type="text" placeholder="precio" class="form-control" value="'.$item["precio"].'"required>
							<input type="hidden" name="editarCantidad" type="text" placeholder="cantidad" class="form-control" value="'.$item["cantidad"].'"required>
							<input type="hidden" name="editarDisponibles" type="text" placeholder="disponibles" class="form-control" value="'.$item["disponibles"].'" required>';
                            ...
                            echo'</select>
							 ...
							 <input type="hidden" value="'.$item["imagenRuta"].'" name="fotoAntigua"><hr>
							 <span><input type="submit" id="actualizarProductoServicio" value="Actualizar" class="btn btn-primary"></span>';
							 echo'</form>
