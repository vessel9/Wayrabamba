	...
	public function borrarArticuloController(){
		...
		if(isset($_GET["idBorrar"])){
			...
			if($datosController == "ok"){
					...
					function(isConfirm){
							 if (isConfirm) {
								 <?php isset($_GET["idBorrar"])unlink($_GET["rutaImagen"]); $datosController = $_GET["idBorrar"]; $respuesta = GestorArticulosModel::borrarArticuloModel($datosController, "articulos");?>
