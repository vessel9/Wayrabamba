			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<div>
						...
						<form method="post" enctype="multipart/form-data">
							<div id="editarImagen"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default"><div id="nuevaFoto"><span class="fa fa-times cambiarImagen"></span><img src="'.$item["imagenRuta"].'" class="img-thumbnail"></div></div><input type="hidden" value="'.$item["idproductoServicio"].'" name="idProductoServicio"><input type="hidden" value="'.$item["imagenRuta"].'"name="fotoAntigua">
