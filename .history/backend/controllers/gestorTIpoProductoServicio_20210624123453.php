...
#BORRAR NEGOCIO
	...
	public function borrarTipoProductoServicioController(){
		...
		if(isset($_GET["idTipoProductoServicio"])){
            ...
            $respuesta = GestorCategoriasModel::borrarCategoriasModel($datosController, "			$respuesta = GestorCategoriasModel::editarCategoriasModel($datosController, "tipoproductoservicio");
			");
