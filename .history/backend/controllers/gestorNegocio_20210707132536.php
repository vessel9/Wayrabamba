...
class GestorNegocio{
	...
	public function mostrarNegociosController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="'.$item["idNegocio"].'" class="bloqueNegocio">
					...
					<b>Telefono: </b><h3>'.$item["telefono"].'</h3>
					<b>Correo: </b><h4>'.$item["correo"].'</h4>
					<b>Direccion: </b><h5>'.$item["direccion"].'</h5>
					<p style="display:none">'.$item["ubicacion"].'</p>
				...
				<div id="negocio'.$item["idNegocio"].'" class="modal fade">
					...
					<div class="modal-dialog modal-content">
						...
						<div class="modal-body" style="border:1px solid #eee">
							...
							<div class="col-md-10 col-md-offset-2">'.$item["ubicacion"].'</div>
