...
class GestorProductoServicio{
	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			<div id="nuevaFoto">
			<span class="fa fa-times"><a href="#<a href="#agregarproductoservicio'.$item["idproductoServicio"].'" data-toggle="modal">'.$item["idproductoServicio"].'"></span>
			...
			<input type="hidden" value="'.$item["imagenRuta"].'" name="fotoAntigua">
					...
					<input style="width:10%; padding:5px 0; margin-top:4px" id="actualizarProductoServicio" type="submit" class="btn btn-primary pull-right" value="Guardar"></span>
