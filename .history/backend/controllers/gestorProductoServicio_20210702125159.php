			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<button type="button" class="close" data-dismiss="modal">&times;</button>
						<form method="post" enctype="multipart/form-data">
						    <input type="submit" id="actualizarProductoServicio" value="Actualizar" class="btn btn-primary">
							...
							$.ajax({
									...
									success: function(respuesta){
										...
										if(respuesta == 0){
											...
											$("#editarImagen").before($(".cambiarImagen").click(function(){
...
<div class="alert alert-warning alerta text-center">La imagen es inferior a 800px * 400px</div>')
										}
										else{
											$("#nuevaFoto").html('<img src="'+respuesta.slice(6)+'" class="img-thumbnail">');
										}	
