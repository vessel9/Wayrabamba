...
class GestorTipoProductoServicio{
	...
	public function editarTipoProductoServicioController(){
		if(isset($_POST["editarNombreTipo"])){
			...
			$respuesta = GestorTipoProductoServicioModel::editarCategoriasModel($datosController, "tipoproductoservicio");
...
#BORRAR NEGOCIO
	...
	public function borrarTipoProductoServicioController(){
		...
		if(isset($_GET["idTipoProductoServicio"])){
            ...
            $respuesta = GestorTipoProductoServicioModel::borrarCategoriasModel($datosController, "tipoproductoservicio");
