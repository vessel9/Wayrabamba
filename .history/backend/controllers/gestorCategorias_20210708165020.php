					...
					<div class="modal-body" style="border:1px solid #eee">
						<form style="padding:0px 10px" method="post" enctype="multipart/form-data">
							 ...
							 <div class="form-group">
							  <input name="editarNombre" type="text" class="form-control" value="'.$item["nombreTipo"].'" required>
							 </div>
								<div class="form-group text-center">
									<input type="submit" id="guardarCategor" value="Actualizar categoria" class="btn btn-primary">
								</div>
						</form>
					</div>
