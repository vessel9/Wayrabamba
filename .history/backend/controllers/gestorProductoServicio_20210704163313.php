		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
				...
				<button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<div id="editarImagen" value="'.$item["imagenRuta"].'"><input style="display:none" type="file" id="subirNuevaFoto" value="'.$item["imagenRuta"].'" class="btn btn-default">
					<div id="nuevaFoto" value="'.$item["imagenRuta"].'">
					<span class="fa fa-times cambiarImagen"></span>
					<img src="+imagenRuta+"  class="img-thumbnail">
				</div></div>
