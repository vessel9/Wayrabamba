	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					if(is_null($item["imagenRuta"]) == FALSE){
					echo '<input type="file" name="editarImagen" class="btn btn-default" id="subirNuevaFoto">';
					}else if(is_null($_FILES["editarImagen"]["tmp_name"]) == true){
						echo '<input type="file" class="btn btn-default" id="subirNuevaFoto">';
					}
