				...
				<div id="negocio'.$item["idNegocio"].'" class="modal fade">
					<div class="modal-dialog modal-content">
						...
						<div class="modal-body" style="border:1px solid #eee">
							...
							<p class="parrafoContenido"><b><spam class="fa fa-phone fa-lg" aria-hidden="true"></span> Telefono: </b> '.$item["telefono"].'</p>
							<h5><b><span class="fa fa-exchange fa-lg" aria-hidden="true"></spam>  Direccion:</b> '.$item["direccion"].'</h5>
