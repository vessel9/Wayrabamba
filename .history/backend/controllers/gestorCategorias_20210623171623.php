	...
	public function mostrarCategoriasController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idCategoria"].'" class="bloqueArticulo">
					...
					<a href="index.php?action=articulos&idBorrarCategoria='.$item["idCategoria"].'">
...
#BORRAR NEGOCIO
	...
	public function borrarCategoriasController(){
		...
		if(isset($_GET["					<a href="index.php?action=articulos&idBorrarCategoria='.$item["idCategoria"].'">
		"])){
