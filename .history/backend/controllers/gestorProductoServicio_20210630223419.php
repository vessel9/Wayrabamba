			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<div>
						...
						<form method="post" enctype="multipart/form-data">
							...
							<span class="fa fa-times cambiarImagen"></span><img src="'.$item["imagenRuta"].'" class="img-thumbnail"></div></div><input type="hidden" value="'.$item["idproductoServicio"].'" name="idProductoServicio"><input type="hidden" value="'.$item["imagenRuta"].'"name="fotoAntigua">
							...
							$mostrarProductoServicio -> mostrarProductoServicioController7();
							 ...
							 <input type="submit" id="actualizarProductoServicio" value="Guardar" class="btn btn-primary">
						</form>
					</div>
