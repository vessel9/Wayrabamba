	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<a href="index.php?action=productoservicio&idBorrar='.$item["idproductoServicio"].'&'.$item["imagenRuta"].'">
   ...
   #MOSTRAR PARA GUARDAR SELECTS OPTION DE TIPO PRODUCTO SERVICIO/ CATEGORIAS/ NEGOCIO
	...
	public function borrarProductoServicioController(){
		...
		if(isset($_GET["idBorrar"])){
			...
			unlink($_GET[$item["imagenRuta"]]);

			$respuestadatosController = $_GET["idBorrar"];
            $ = GestorProductoServicioModel::borrarProductoServicioModel($datosController, "productoservicio");
