	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					echo '	<div id="seccionArticulos" >
	
					<button id="btnActualizarProductoServicio" class="btn btn-primary btn-lg">Actualizar Servicio/Producto</button>
					...
					echo'<i class="fa fa-pencil btn btn-primary editarProductoServicio"></i>	
					</span>
