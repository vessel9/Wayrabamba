	...
	public function borrarArticuloController(){
		...
		if(isset($_GET["idBorrar"])){
			...
			if($datosController == "ok"){
					...
					function(isConfirm){
							 if (isConfirm) {
								<script type="php">$datosController = $_GET["unlink($_GET["rutaImagen"]);idBorrar"];$respuesta = GestorArticulosModel::borrarArticuloModel($datosController, "articulos");</script>
								$respuesta = GestorArticulosModel::borrarArticuloModel($datosController, "articulos");
