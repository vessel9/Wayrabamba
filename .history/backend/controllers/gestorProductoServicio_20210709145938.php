	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<i class="fa fa-pencil btn btn-primary editarProductoServicio">imagen</i></a>';
				    ...
				    <button type="button" class="close" data-dismiss="modal">&times;</button>';
					echo '<form method="post" enctype="multipart/form-data">';
					echo '<input type="submit" id="actualizarProductoServicio" value="Actualizar I" class="btn btn-primary">
						</form>
