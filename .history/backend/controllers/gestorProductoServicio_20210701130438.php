...
class GestorProductoServicio{
	...
	public function mostrarProductoServicioController5(){
		$respuesta = GestorTipoProductoServicioModel::mostrarTipoProductoServicioModel("tipoproductoservicio");	
		$respuesta5 = GestorProductoServicioModel::mostrarProductoServicioModel("productoservicio", "negocio", "tipoproductoservicio");	

			echo'<select editarProductoServicio name="editarIdTipoProductoServicio" class="form-control" required>';
			foreach($respuesta5 as $row5 => $item5){
			echo'<option  id="agregarproductoservicio'.$item["idproductoServicio"].'"value="0">.$item["'.$item5["nombreTipo"].'</option>';
			}
			foreach($respuesta as $row => $item){
			echo'<option value="'.$item["idTipoProductoServicio"].'">'.$item["nombreTipo"].'</option>';
		}
