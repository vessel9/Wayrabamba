		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
				...
				<button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<input type="hidden" value="'.$item["imagenRuta"].'" name="editarImagen">
					<input type="file" name="editarImagen" class="btn btn-default" id="subirFoto" required>

					<input style="width:10%; padding:5px 0; margin-top:4px" id="actualizarProductoServicio" type="submit" class="btn btn-primary pull-right" value="Actualizar"></span>
