			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
				...
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					...
					echo '
						...
						echo '<label> Disponibilidad</label><select editarProductoServicio name="editarIdTipoProductoServicio" class="form-control">
						...
						echo '<label> Disponibilidad</label><select name="editarIdCategoria" class="form-control">
						...
						echo'<label> Disponibilidad</label><select name="editarIdNegocio" class="form-control">
						...
						echo'</select>';
							if($_SESSION["rol"] == 0){
				        echo'<label> Disponibilidad</label><select name="editarEstado" class="form-control">';
