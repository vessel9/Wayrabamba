			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<button type="button" class="close" data-dismiss="modal">&times;</button>
						<form method="post" enctype="multipart/form-data">
							<div id="editarImagen"><input type="file" id="subirNuevaFoto" class="btn btn-default">
							<div id="nuevaFoto">
							...
							echo'<option value="'.$item5["idTipoProductoServicio"].'">'.$item5["nombreTipo"].'</option>';
							 ...
							 <input style="display:none"type="hidden" value="'.$item["imagenRuta"].'" name="fotoAntigua"><hr>';
