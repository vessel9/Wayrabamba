	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<button id="btnActualizarProductoServicio'.$item["idproductoServicio"].'" class="btn btn-primary btn-lg">Actualizar Servicio/Producto</button>
					<div id="actualizarProductoServicio'.$item["idproductoServicio"].'" style="display:none">
