...
class GestorCategorias{
	...
	public function mostrarCategoriasController(){
		...
		foreach($respuesta as $row => $item) {
			...
			<a href="index.php?action=tipoproductoservicio&idConfirmarCategoria='.$item["idCategoria"].'"><i class="fa fa-times btn btn-danger"></i></span></a></td>
		  </tr>
	...
	public function confirmarBorrarCategoriaController(){
		


		if(isset($_GET["idConfirmarCategoria"])){
			...
			$respuesta = GestorCategoriasModel::mostrarCategoriasModel("categorias");	
				...
				foreach($respuesta as $row => $item) {
					...
					function(isConfirm){
							 if (isConfirm) {							
								window.location.href="index.php?action=tipoproductoservicio&idBorrarCategoria=.$_GET["idConfirmarCategoria"].";							
							  } else {
