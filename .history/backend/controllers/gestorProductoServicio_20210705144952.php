...
class GestorProductoServicio{
	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			<div id="nuevaFoto">
			<span class="fa fa-times cambiarImagen&cambiarImagen='.$item["idproductoServicio"]&'.$item["imagenRuta"].'"></span>
			<a href="index.php?action=productoservicios&cambiarImagen='.$item["idproductoServicio"].'&'.$item["imagenRuta"].'">
			</a>
