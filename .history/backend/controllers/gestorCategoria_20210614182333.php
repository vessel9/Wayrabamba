...
class GestorCategoria{
	...
	public function mostrarCategoriaController(){
		...
		// foreach($respuesta as $row => $item) {
			...
			echo ' <li id="idCategoria" class="bloqueArticulo">
					<span class="handleArticle">
				
					<i class="fa fa-pencil btn btn-primary editarArticulo"></i>	
					</span>
				
					<h1>'.$respuesta["nombreCategoria"].' hola este es categorias</h1>

					<hr>

				</li>

				<div id="articulo'.$respuesta["idCategoria"].'" class="modal fade">
					...
					<div class="modal-dialog modal-content">
						...
						<div class="modal-header" style="border:1px solid #eee">
						 ...
						 <h3 class="modal-title">'.$respuesta["nombreCategoria"].'</h3>
