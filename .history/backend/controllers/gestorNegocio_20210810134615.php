...
class GestorNegocio{
	...
	public function mostrarImagenController($datos){
		...
		if($ancho < 800 || $alto < 400){
			...
			$ruta2 = "../../views/images/negocios/temp/negocio".$aleatorio2.".jpg";
			$origen2 = imagecreatefromjpeg($datos);
			$destino2 = imagecrop($origen2, ["x"=>0, "y"=>0, "width"=>800, "height"=>400]);
				...
				<div id="negocio'.$item["idNegocio"].'" class="modal fade">
					<div class="modal-dialog modal-content">
						...
						<div class="modal-body" style="border:1px solid #eee">
							...
							<p class="parrafoContenido"><b><span class="fa fa-phone fa-lg" aria-hidden="true"></span> Telefono: </b> '.$item["telefono"].'</p>
							<h5><b><span class="fa fa-exchange fa-lg" aria-hidden="true"></span>  Direccion:</b> '.$item["direccion"].'</h5>
							<b><span class="fa fa-map-marker fa-lg" aria-hidden="true"></span> Ubicacion: </b><div class="col-md-10 col-md-offset-2">'.$item["ubicacion"].'</div>
						</div>
