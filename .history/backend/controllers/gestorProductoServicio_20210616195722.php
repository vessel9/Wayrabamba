...
class GestorProductoServicio{
	...
	public function mostrarProductoServicioController(){
		...
		$respuesta = GestorProductoServicioModel::mostrarProductoServicioModel("productoservicio");	
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<a href="index.php?action=articulos&idBorrar='.$item["idproductoServicio"].'&rutaImagen='.$item["imagenNegocio"].'">
