...
class GestorSlide{
	...
	public function mostrarImagenVistaController(){
		...
		foreach($respuesta as $row => $item){
			...
			echo '<li id="'.$item["id"].'" class="bloqueSlide"><span class="fa fa-times" href="index.php?action=articulos&idConfirmar"></span><img src="'.substr($item["ruta"], 6).'" class="handleImg"></li>';
