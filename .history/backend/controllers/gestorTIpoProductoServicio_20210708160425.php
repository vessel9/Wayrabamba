...
class GestorTipoProductoServicio{
	...
	public function mostrarTipoProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			<td><a href="#perfil'.$item["idTipoProductoServicio"].'" data-toggle="modal"><span class="btn btn-info fa fa-pencil"></span></a>
		   ...
		   <div id="perfil'.$item["idTipoProductoServicio"].'" class="modal fade">
