...
class GestorCategoria{
	...
	public function mostrarCategoriaController(){
		...
		foreach($respuesta as $row => $item) {
			// echo "<script>console.log('consoila categoria: " . $respuesta . "' );</script>";
			...
			echo ' <li id="'.$item["id"].'" class="bloqueArticulo">
					...
					<h1>'.$item["titulo"].' hola este es categorias</h1>

					<hr>

				</li>

				<div id="categorias'.$item["idCategoria"].'" class="modal fade">
