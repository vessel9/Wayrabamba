			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<div>
						...
						<form method="post" enctype="multipart/form-data">
							<div id="editarImagen"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default"><div id="nuevaFoto">
							...
							<input type="hidden" value="'.$item["imagenRuta"].'" name="fotoAntigua">
							...
							echo'		
							<select editarProductoServicio name="editarIdTipoProductoServicio" class="form-control">
							<option value="0">'.$item["nombreTipo"].'</option>';
							...
							echo'<option value="'.$item5["idTipoProductoServicio"].'">'.$item5["nombreTipo"].'</option>';
						     ...
						     echo'</select>';
							 echo'			
							 <select name="editarIdCategoria" class="form-control">
							 <option value="0">'.$item["nombreCategoria"].'</option>';
							 foreach($respuesta6 as $row6 => $item6){
							 echo'<option value="'.$item6["idCategoria"].'">'.$item6["nombreCategoria"].'</option>';
						     }
							 echo'</select>';
							 echo'			
			                 <select name="editarIdNegocio" class="form-control">
			                 <option value="0">'.$item["nombreNegocio"].'</option>';
					...
					<h6>tipo id:'.$item["idTipoProductoServicio"].'<h6>
					<h6>categoria  id:'.$item["idTipoProductoServicio"].'<h6>
					<h6>negocio id:'.$item["idTipoProductoServicio"].'<h6>
