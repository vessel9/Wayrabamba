	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<i class="fa fa-pencil btn btn-primary editarProductoServicio">imagen</i>	
					';
					...
					<h5><b>Cantidad: </b>'.$item["cantidad"].'</<i class="fa fa-html5" aria-hidden="true"></i>>
					<h5><b>Disponibles: </b>'.$item["disponibles"].'</h4>
					<h5><b>tipo: </b>'.$item["nombreTipo"].'<h4>
					<h5><b>Categoria: </b>'.$item["nombreCategoria"].'</h4>
					<h5><b>Negocio: </b>'.$item["nombreNegocio"].'</h4>
					';
					...
					echo '<input name="editarNombreProductoServicio" type="text" placeholder="Nombre producto" class="form-control" value="'.$item["nombreProductoServicio"].'" required>
                        ...
                        <hr>
						';
						echo '<input type="submit" id="actualizarProductoServicio" value="Actualizar Produc" class="btn btn-primary">
						</form>
