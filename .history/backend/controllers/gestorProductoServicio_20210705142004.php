	...
	public function mostrarProductoServicioController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					echo '<id="'.$item["idproductoServicio"].'"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default">
					<span class="fa fa-times cambiarImagen"></span>
					<img src="'.$item["imagenRuta"].'"  class="img-thumbnailb"></div>
					';
