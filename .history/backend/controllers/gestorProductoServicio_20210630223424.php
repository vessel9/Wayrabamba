			...
			echo ' <li id="'.$item["idproductoServicio"].'" class="bloqueNegocio">
					...
					<div>
						...
						<form method="post" enctype="multipart/form-data">
							...
							<img src="'.$item["imagenRuta"].'" class="img-thumbnail"></div></div><input type="hidden" value="'.$item["idproductoServicio"].'" name="idProductoServicio"><input type="hidden" value="'.$item["imagenRuta"].'"name="fotoAntigua">
