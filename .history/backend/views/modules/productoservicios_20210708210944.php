...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<button id="btnAgregarProductoServicio" class="btn btn-info btn-lg"><a href="tipoproductoservicio" style="color:white;"><span class="fa fa-newspaper-o"></span>Agregar Servicio/Producto</a></button>fa fa-plus-square
	
	<button  class="btn btn-success btn-lg" style="background:#D6D455;color: white;border: 2px solid #D6D455;"><a href="tipoproductoservicio" style="color:white;"><span class="fa fa-newspaper-o"></span> Tipos/Categorias</a></button>
	<button  class="btn btn-warning btn-lg"><a href="negocios" style="color:white;"><span class="fa fa-shopping-bag"></span> Negocios</a></button>
