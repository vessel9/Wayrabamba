...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarNegocio" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input name="telefonoNegocio" type="tel" onkeydown="return event.keyCode !== 69"  minlength="9" maxlength="9"  oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="Teléfono" class="form-control" required>
