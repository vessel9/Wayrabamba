    ...
    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12"  id="btext">
         ...
         <nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
                    <ul class="nav navbar" >
                        ...
                        <li><a href="inicio" style="color:black;">Inicio <span class="glyphicon glyphicon-home text-info" style="color:white;"></span></a></li>
white                        <li><a href="articulos" style="color:white;">Artículos <span class="glyphicon glyphicon-list-alt" style="color:white;"></span></a></li>
