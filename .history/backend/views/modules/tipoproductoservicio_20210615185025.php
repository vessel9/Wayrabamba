...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarArtículo" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input type="submit" id="guardarCategoria" value="Guardar Tipoproductoservicio" class="btn btn-primary">
	...
	<?php
		...
		$mostrartipoproductoservicio = new GestorTipoProductoServicioModel();
