...
<div id="crearPerfil" class="col-lg-5 col-md-12 col-sm-6 col-xs-12">
	...
	<?php
		...
		$guardarChat -> mostrarChatController();
	?>
	<!--==== EDITAR ARTÍCULO  ====-->
	</hr>
    ...
    <?php
	  ...
	  $verChatbot -> mostrarTipoProductoServicioController();
	  $verChatbot -> confirmarBorrarTipoController();
	  $verChatbot -> borrarTipoProductoServicioController();
