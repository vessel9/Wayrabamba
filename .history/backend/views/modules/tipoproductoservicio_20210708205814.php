...
<div id="crearPerfil" class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
	...
	<button id="btnAgregarTipoProductoServicio" class="btn btn-war btn-lg"><a href="tipoproductoservicio" style="color:white;"><span class="fa fa-plus-square"></span> Tipo Servicio/Producto</a></button>
