...
<div id="inicio" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<ul>
		...
		<!-- <li class="botonesInicio">
	        ...
	        <li class="botonesInicio">
			<a href="articulos">
			<div style="background-color: #008CBA;color: white;border: 2px solid #008CBA;" 	onMouseOver="this.style.cssText='color: #cc0000'"style="hover;background-color: white;color:#008CBA;}">
