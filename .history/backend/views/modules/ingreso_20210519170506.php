...
<div id="backIngreso">
	...
	<img src="views/images/logo2.png" class="img-responsive" alt="Image">
		...
		<input class="form-control formIngreso" type="password" placeholder="Ingrese su Contraseña" name="passwordIngreso" id="passwordIngreso"><span class="glyphicon glyphicon-arrow-right" id=clickme width=28 height=25></span>
