    ...
    <div id="btext">
         ...
         <nav id="sidebar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
                    ...
                    <ul class="list-unstyled components"><br>
                        <li><a href="inicio" style="color:white;"><span class="glyphicon glyphicon-home text-info" style="color:white;"></span> </a>Inicio</li>
                        ...
                        <li><a href="visitas" style="color:white;"><span class="glyphicon glyphicon-expand" style="color:white;"></span> visitas</a></li>
