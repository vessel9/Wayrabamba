...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarNegocio" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input name="telefono" type="text" placeholder="Nombre de Negocio" class="form-control" required>
			<input name="direccion" type="text" placeholder="Nombre de Negocio" class="form-control" required>
			<input name="nombreCategoria" type="text" placeholder="Nombre de Negocio" class="form-control" required>
