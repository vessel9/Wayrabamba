...
======================================-->
	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1" style="background-image: url('views/images/sidebar.jpg');background-repeat: no-repeat;background-size: cover;font-family: Arial, Helvetica, sans-serif;filter: blur(10px);">
