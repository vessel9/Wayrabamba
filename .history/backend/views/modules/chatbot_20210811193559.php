...
<div id="crearPerfil" class="col-lg-5 col-md-12 col-sm-6 col-xs-12">
	...
	<div id="agregarChat" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input name="nombresTipoProductoServicio" tyle="text-transform:capitalize;" type="text" placeholder="Nombre de Tipo Producto" class="form-control" required>
            <input name="nombresTipoProductoServicio" " type="text" placeholder="Nombre de Tipo Producto" class="form-control" required>
