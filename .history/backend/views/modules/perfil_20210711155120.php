     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        if($_SESSION["rol"] == 0){
          ...
          <option value="<?php echo $_SESSION["rol"];?>"><?php if($_SESSION["rol"] == 0){echo'Administrador';} else{echo'Administrador';}?></option>
          <?php echo'<option value="0">Administrador</option>
          <option value="1">Editor</option>
