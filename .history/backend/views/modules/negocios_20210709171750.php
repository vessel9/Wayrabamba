...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<button id="btnAgregarNegocio" class="btn btn-info btn-lg"><a style="color:white;"><span class="fa fa-plus-square"></span>Agregar Negocio<></button>
	...
	<div id="agregarNegocio" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input name="correoNegocio" type="text" style="text-transform:capitalize;" placeholder="Dierección" class="form-control" required><span id="emailOK"></span>
			<input name="direccionNegocio" type="email"  id="email" placeholder="email" class="form-control" required><span id="emailOK"></span>
