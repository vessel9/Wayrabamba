    ...
    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12"  id="btext">
         ...
         <nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
                    <ul class="nav navbar">
                        ...
                        <li><a href="categorias" style="color:white;">Categoria <span class="glyphicon glyphicon-expand" style="color:white;"></span></a></li>
                        <li><a href="tipoproductoservicio" style="color:white;">Tipo producto o servicio <span class="glyphicon glyphicon-expand" style="color:white;"></span></a></li>
                        <li><a href="negocios" style="color:white;">Tipo producto o servicio <span class="glyphicon glyphicon-expand" style="color:white;"></span></a></li>
