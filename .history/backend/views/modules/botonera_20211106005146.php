...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1" role="navigation">
       <div id="logo" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div id="sidebarMovil" class="navbar-header navbar-inverse text-center">

          <button type="button" class="navbar-toggle pull-center" data-toggle="collapse" data-target=".navbar-ex1-collapse">
        ...
        <!--====  Fin de BOTONERA MOVIL  ====-->
         ...
         <nav id="sidebar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse navbar-ex1-collapse text-center">
                    ...
                    <ul class="list-unstyled components"><br>
                        ...
                        <li><a href="visitas" style="color:white;"><span class="fa fa-bullseye" style="color:white;"></span> visitas</a></li>
