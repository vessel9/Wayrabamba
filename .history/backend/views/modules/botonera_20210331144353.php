...
======================================-->
	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center text-success">
					
			<ul class="nav navbar">

				<a href="inicio">Inicio <span class="glyphicon glyphicon-home"></span></a></li>
				...
				<h1 class="display-4">Ejemplo h1 display-1</h1><p>Texto del ejemplo</p>
				<?php 
