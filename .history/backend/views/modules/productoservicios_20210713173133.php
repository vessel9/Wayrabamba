...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<select name="estado" class="form-control"><option value="">Selecciona Estado</option>'<option value="publico">Publico</option> <option value="privado">Privado</option></select>			
