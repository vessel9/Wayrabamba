     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        if($_SESSION["rol"] == 0){
             ...
             echo'<select name="editarRol" class="form-control" required>
          ...
          <option value="<?php echo $_SESSION["rol"];?>"><?php if($_SESSION["rol"] == 0){echo'Administrador';} else{echo'Editor';}?></option>
          <?php echo'</select>';
        }
        ?>
       ...
       <div class="form-group text-center">
          ...
          <input type="file" class="btn btn-default" id="cambiarFotoPerfil" style="display:inline-block; margin:10px 0" requires>
