...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarProductoServicio" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input name="descripcion" type="text"  style="text-transform:uppercase;" placeholder="descripcion" class="form-control" required onkeyup="javascript:this.value=this.value.toUpperCase();">
