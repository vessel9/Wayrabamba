...
<div>
		<button type="button" class="botton btn-center btn btn-success"><a href="../index.php" target="_blank"><span class="glyphicon glyphicon-globe"></a>&nbsp;Ir al sitio</span></button>
