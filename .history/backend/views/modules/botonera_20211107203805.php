...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1" role="navigation">        </div
       <div id="logo" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div id="botoneraMovil" class="navbar-header navbar-inverse text-center">

          <button type="button" class="navbar-toggle pull-center" data-toggle="collapse" data-target="#sidebar">
