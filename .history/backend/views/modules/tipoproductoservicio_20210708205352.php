...
<div id="crearPerfil" class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
	...
	<button id="btnAgregarTipoProductoServicio" class="btn btn-info btn-lg"><a href="tipoproductoservicio" style="color:white;"><span class="fa fa-newspaper-o"></span>Agregar Tipo Servicio/Producto</a></button>
