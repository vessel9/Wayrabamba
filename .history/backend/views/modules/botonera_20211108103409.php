...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
       ...
       <div id="logo" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div id="sidebarMovil" class="navbar-header navbar-inverse">
        ...
        <li class="nav-item d-xl-none ps-3 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0" id="iconNavbarSidenav" data-target="#sidebar">
        ...
        <!--====  Fin de BOTONERA MOVIL  ====-->
         ...
         <nav id="sidebar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
                    ...
                    <ul class="list-unstyled components">
                        <li><a href="inicio" style="color:black;"><span class="glyphicon glyphicon-home text-info" style="color:white;"></span> Inicio</a></li>
