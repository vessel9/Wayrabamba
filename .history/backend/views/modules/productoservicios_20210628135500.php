...
?>
	...
	<?php $query=mysqli_query($mysqli, "SELECT idproductoServicio, nombreProductoServicio, descripcion, imagenRuta, precio, cantidad, disponibles, idTipoProductoServicio, idCategoria, idNegocio FROM $tabla ORDER BY idproductoServicio ASC");
	?>
<!--=====================================
