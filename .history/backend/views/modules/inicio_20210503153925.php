...
function normalImg(x) {
  ...
  x.style.width = "150px";
		...
		<li class="botonesInicio" >
			...
			<a href="slide">
			<div style="background-color:#4CF53A; color: white;border: 2px solid #4CF53A;" onMouseOver="bigImg(this)" onMouse="normalImg(this)" onMouseOver="this.style.backgroundColor='#40d41c'"  onMouseOut="this.style.backgroundColor = '#4CF53A'">
