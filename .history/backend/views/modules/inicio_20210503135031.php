...
<div id="inicio" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<ul>
		...
		<!-- <li class="botonesInicio">
	       ...
	       <li>
			<a href="articulos">
			<div style="background-color: #008CBA;color: white;border: 2px solid #008CBA;" style="hover.background-color: white;color:#008CBA;}>
		...
		<button style="background-color: #008CBA;color: white;border: 2px solid #008CBA;" style="hover.background-color: white;color:#008CBA;}">Green</button>
