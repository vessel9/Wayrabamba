	...
	<ul>
		...
		<script type="text/javascript">
          function pintar(objeto,col)
	        ...
	        <li class="botonesInicio">
			<a href="articulos">
			<div style="background-color: #008CBA;color: white;border: 2px solid #008CBA;" 	onMouseOver="this.style.backgroundColor='#83D7E4 '" onMouseOut="this.style.backgroundColor = '#008CBA'">
