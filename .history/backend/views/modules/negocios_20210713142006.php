...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarNegocio" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input name="correoNegocio" type="email" id="email"  placeholder="mail" class="form-control" required><span id="emailOK"></span>
			<input name="direccionNegocio" type="text"  style="text-transform:capitalize;" placeholder="Direccion" class="form-control" required>
