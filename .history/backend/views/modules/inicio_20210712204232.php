...
<div id="inicio" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<ul>
		...
		<li class="botonesInicio">
			...
			<a href="videos">
			<div style="background:#1434AD;color: white;border: 2px solid #1434AD;" onMouseOver="this.style.width='181px';this.style.height='180px';this.style.backgroundColor='#0004ff'" onMouseOut="this.style.width='150px';this.style.height='150px';this.style.backgroundColor = '#1434AD'"> 
