...
======================================-->
	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<button type="button" class="btn btn-success col-lg-6 col-md-6 col-sm-6 col-xs-6"><a href="../index.php" target="_blank"><span class="glyphicon glyphicon-globe"></a>&nbsp;Ir al sitio</span></button>
