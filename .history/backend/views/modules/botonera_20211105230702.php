...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
       <div id="logo" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div id="botoneraMovil" class="sidebar-header sidebar-inverse">
        ...
        <!--====  Fin de BOTONERA MOVIL  ====-->
         ...
         <nav id="sidebar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse sidebar-collapse text-center">
