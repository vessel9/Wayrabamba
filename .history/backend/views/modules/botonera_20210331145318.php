	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
			...
			<ul class="nav navbar">
				...
				<li><a href="slide" style="color:white;">Slide <span class="glyphicon glyphicon-new-window" style="color:white;"></span></a></li>
				<li><a href="articulos" style="color:white;">Artículos <span class="glyphicon glyphicon-new-window" style="color:white;"></span></a></li>
				<li><a href="galeria" style="color:white;">Imágenes <span class="glyphicon glyphicon-picture"></span></a></li>
				<li><a href="videos" style="color:white;">Videos <span class="glyphicon glyphicon-expand"></span></a></li>
		...
		<button type="button" class="btn btn-success"><a href="../index.php" target="_blank"><span class="glyphicon glyphicon-globe" style="color:white;"></a>&nbsp;Ir al sitio</span></button>
		</div>
