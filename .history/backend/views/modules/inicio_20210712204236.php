...
<div id="inicio" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<ul>
		...
		<a href="negocios">
		<div style="background:#17202A;color: white;border: 2px solid #71899F;" onMouseOver="this.style.width='181px';this.style.height='180px';this.style.backgroundColor='#000000'" onMouseOut="this.style.width='150px';this.style.height='150px';this.style.backgroundColor = '#17202A'"> 
