...
<div id="inicio" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<ul>
	   ...
	   <li class="botonesInicio">
		...
		<div style="background:#D6D455;color: white;border: 2px solid #D6D455;" onMouseOver="this.style.width='181px';this.style.height='180px';this.style.backgroundColor='#ECE80E'" onMouseOut="this.style.width='150px';this.style.height='150px';this.style.backgroundColor = '#D6D455'"> 
