...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<button id="btnAgregarProductoServicio" class="btn btn-info btn-lg"><a href="tipoproductoservicio" style="color:white;"><span class="fa fa-newspaper-o"></span> Servicio/Producto</a></button>
