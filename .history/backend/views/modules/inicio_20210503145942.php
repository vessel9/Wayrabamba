...
<div id="inicio" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<ul>
		...
		<li class="botonesInicio">
			...
			<a href="galeria">
			<div style="background:#04E6DE;color: white;border: 2px solid #04E6DE;" onMouseOver="this.style.backgroundColor='#00888f'" onMouseOut="this.style.backgroundColor = '#04E6DE'">
