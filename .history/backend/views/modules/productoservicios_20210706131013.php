...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarProductoServicio" style="display:none">
		...
		<form method="post" enctype="multipart/form-data">
            ...
            <input name="precio" type="number" min="10" max="100" onkeydown="return event.keyCode !== 69"  step="0.01" placeholder="precio" class="form-control" required>
			<input name="cantidad" type="number" min="10" max="100" onkeydown="return event.keyCode !== 69" placeholder="cantidad" class="form-control" required>
			<input name="disponibles" type="number" min="10" max="100" onkeydown="return event.keyCode !== 69" placeholder="disponibles" class="form-control" required>
