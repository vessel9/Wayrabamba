	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
			...
			<ul class="nav navbar">
				...
				<li><a href="videos">Videos <span class="glyphicon glyphicon-play-circle"></span></a></li>
		...
		<a href="../index.php" target="_blank"><button type="button" class="button btn btn-success" >Ir sitio</button></a>
