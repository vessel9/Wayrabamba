    ...
    <div id="btext">
         ...
         <nav id="sidebar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
                    ...
                    <ul class="list-unstyled components"><br>
                        ...
                        <li><a href="galeria" style="color:white;"><span class="glyphicon glyphicon-picture" style="color:white;"> Imágenes</span></a></li>
                        <li><a href="videos" style="color:white;"><span class="glyphicon glyphicon-expand" style="color:white;"></span></a></li>
