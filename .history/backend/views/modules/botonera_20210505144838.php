...
======================================-->
	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<div id="logo" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-image: url('views/images/sidebar-4.jpg');background-repeat: no-repeat;background-size: cover;font-family: Ginebra;" class="img-responsive">
		...
		<nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center" style="background-image: url('views/images/sidebar-4.jpg');background-repeat: no-repeat;background-size: cover;font-family: Ginebra;" class="img-responsive" >
