...
<div id="backIngreso">
	...
	<img src="views/images/logo2.png" class="img-responsive" alt="Image">
		...
		<div type="submit" style="background:#04E6DE;color: white;border: 2px solid #04E6DE;"  onMouseOver="this.style.width='200px';this.style.height='200px';this.style.backgroundColor='#00c9bf'" onMouseOut="this.style.width='150px';this.style.height='150px';this.style.backgroundColor = '#04E6DE'">
