...
<div id="" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	
	<button id="btnAgregarArticulo" class="btn btn-info btn-lg"><span class="fa fa-plus-square"></span> Agregar Artículo</button>
