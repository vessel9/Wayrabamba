...
?>
<!--=====================================
GESTOR DE PREGUNTAS Y RESPUESTAS PARA EL CHAST        
======================================-->

<div id="crearPerfil" class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
	
	<button id="btnAgregarChat" class="btn btn-success btn-lg"><a style="color:white;"><span class="fa fa-plus-square"></span> Tipo Servicio/Producto</a></button>
