...
<!-- <img src="views/images/logotipo.jpg" class="img-responsive" alt="Image"> -->
	...
	<div class="jumbotron" style="background-image: url('https://static.vecteezy.com/system/resources/previews/001/226/022/non_2x/background-blue-and-white-squares-vector.jpg');background-repeat: no-repeat;background-size: cover;font-family: Lucida Bright;" class="img-responsive">
