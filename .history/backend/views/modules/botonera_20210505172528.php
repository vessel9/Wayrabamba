...
COLUMNA BOTONERA           
======================================-->
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="pageb"></div>
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1" >
		...
		<!-- <img src="views/images/sidebar-4.jpg" class="img-responsive" alt="Image"> -->
			...
			<ul class="nav navbar">
				...
				<li><a href="inicio" style="color:white;">Inicio</b><span class="glyphicon glyphicon-home text-info" style="color:white;"></span></a></li>
