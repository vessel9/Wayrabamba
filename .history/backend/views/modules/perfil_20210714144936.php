...
echo '<div id="crearPerfil" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	...
	<button id="registrarPerfil" style="margin-bottom:20px" class="btn btn-success"><span class="fa fa-plus-square"></span> NMuevo miembro</button>
     ...
     <div class="form-group">
      ...
      <div class="form-group">
       ...
       <div class="form-group text-center">
          ...
          <input type="file" class="btn btn-default" id="subirFotoPerfil" name="nuevaImagen" style="display:inline-block; margin:10px 0">
