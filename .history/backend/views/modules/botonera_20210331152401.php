...
======================================-->
	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<a href="../index.php" target="_blank"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-globe" style="color:white;"></span></button></a>&nbsp;Ir al sitio
		</div>
