...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<button  class="btn btn-success btn-lg" style="background:#D6D455;color: white;border: 2px solid #D6D455;"><a href="perfil"><span class="fa fa-user"></span> Tipos/Categorias</a></button>
