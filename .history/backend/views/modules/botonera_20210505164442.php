...
======================================-->
	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1" >
		...
		<!-- <img src="views/images/sidebar-4.jpg" class="img-responsive" alt="Image"> -->
			...
			<ul class="nav navbar" style="background-image: url('views/images/sidebar.jpg');background-repeat: no-repeat;background-size: cover;-webkit-filter: blur(1px)font-family: Arial, Helvetica, sans-serif;" >
