...
<div id="inicio" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<ul>
		...
		<li class="botonesInicio">
			...
			<a href="slide">
			<div style="background-color:#4CF53A; color: white;border: 2px solid #4CF53A;" onMouseOver="this.style.backgroundColor='#40d41c',this.style.width='18'" onMouseOut="this.style.backgroundColor = '#4CF53A'">
