...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1"></div>
    ...
    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12"  id="btext">
         ...
         <nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
                    <ul class="nav navbar">
                        ...
                        <li><a href="videos" style="color:white;">Videos <span class="glyphicon glyphicon-expand" style="color:white;"></span></a></li>                        <li><a href="videos" style="color:white;">Videos <span class="glyphicon glyphicon-expand" style="color:white;"></span></a></li>
