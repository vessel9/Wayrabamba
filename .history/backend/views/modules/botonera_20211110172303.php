...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
       ...
       <div id="logo" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div id="botoneraMovil" class="navbar navbar-inverse" >
        ...
        <!--====  Fin de BOTONERA MOVIL  ====-->
         ...
         <nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center" role="navigation">
