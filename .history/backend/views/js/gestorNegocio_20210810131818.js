		...
		$.ajax({
			...
			success: function(respuesta){
					...
					if(respuesta == 0){
						...
						$("#arrastreImagenarrastreImagenNegocioNegocio").before('<div class="alert alert-warning alerta text-center">Se recomienda la imagen de 800px * 400px, esta es inferior pero se guaradara</div>')
