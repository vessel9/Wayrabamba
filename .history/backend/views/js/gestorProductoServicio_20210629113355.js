...
$(".editarProductoServicio").click(function(){
	...
	precio = $("#"+idProductoServicio).children("h1").html();
    cantidad = $("#"+idProductoServicio).children("h1").html();
    disponibles = $("#"+idProductoServicio).children("h1").html();
