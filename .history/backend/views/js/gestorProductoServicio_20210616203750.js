...
$(".editarProductoServicio").click(function(){
	...
	$("#"+idProductoServicio).html('<form method="post" enctype="multipart/form-data"><span><input style="width:10%; padding:5px 0; margin-top:4px" type="button" class="btn btn-danger pull-right" value="Cancelar" data-dismiss="modal"  onClick="cierraProductoServicios()"><input style="width:10%; padding:5px 0; margin-top:4px" type="submit" class="btn btn-primary pull-right" value="Guardar"></span><div id="editarImagen"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default"><div id="nuevaFoto"><span class="fa fa-times cambiarImagen"></span><img src="'+rutaImagen+'" class="img-thumbnail"></div></div><input type="text" value="'+nombreProductoServicio+'" name="editarNombreProductoServicio"><textarea cols="30" rows="5" name="editarDescripcion">'+descripcion+'</textarea><textarea name="editarTipoProductoServicio" id="editaridTipoProductoServicio" cols="30" rows="10">'+idTipoProductoServicio+'</textarea><textarea name="editarTipoProductoServicio" id="editaridTipoProductoServicio" cols="30" rows="10">'+idTipoProductoServicio+'</textarea><textarea name="editarTipoProductoServicio" id="editaridTipoProductoServicio" cols="30" rows="10">'+idTipoProductoServicio+'</textarea><input type="hidden" value="'+idProductoServicio+'" name="id"><input type="hidden" value="'+rutaImagen+'" name="fotoAntigua"><hr></form>');
