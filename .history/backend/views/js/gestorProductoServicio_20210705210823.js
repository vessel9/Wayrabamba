...
$(".editarProductoServicio").click(function(){
	...
	$("#"+idProductoServicio).html('<div><form method="post" enctype="multipart/form-data"><span><input style="width:10%; padding:5px 0; margin-top:4px" type="button" class="btn btn-danger pull-right" value="Cancelar" data-dismiss="modal"  onClick="cierraProductoServicios()"><input style="width:10%; padding:5px 0; margin-top:4px" type="submit" class="btn btn-primary pull-right" value="Actualizar"></span><div id="editarImagen"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default"><div id="nuevaFoto"><span class="fa fa-times cambiarImagen"></span><img src="'+imagenRuta+'" class="img-thumbnail"></div></div><input type="hidden" value="'+idProductoServicio+'" name="idProductoServicio"><input type="text" value="'+nombreProductoServicio+'" name="editarNombreNegocio"><input type="hidden" value="'+imagenRuta+'" name="fotoAntigua"><hr></form></div>');
