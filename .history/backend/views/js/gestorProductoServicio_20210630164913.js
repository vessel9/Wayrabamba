...
$("#btnActualizarProductoServicio'.$item["idproductoServicio"].'").click(function(){

	$("#actualizarProductoServicio'.$item["idproductoServicio"].'").toggle(400);
