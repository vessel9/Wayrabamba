...
$(".editarNegocio").click(function(){
	...
	$("#"+idNegocio).html('<form method="post" enctype="multipart/form-data"><span><input style="width:10%; padding:5px 0; margin-top:4px" type="button" class="btn btn-danger pull-right" value="Cancelar" data-dismiss="modal"  onClick="cierraNegocios()"><input style="width:10%; padding:5px 0; margin-top:4px" type="submit" class="btn btn-primary pull-right" value="Guardar"></span><div id="editarImagen"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default"><div id="nuevaFoto"><span class="fa fa-times cambiarImagen"></span><img src="'+imagenNegocio+'" class="img-thumbnail"></div></div><br><label> Nombre del Negocio</label><input type="text" style="text-transform:capitalize;" value="'+nombreNegocio+'" name="editarNombreNegocio"><label> Teléfono</label><input type="number" value="'+telefono+'" onkeydown="return event.keyCode !== 69"  minlength="10" maxlength="10"  oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="editarTelefono"><label> Link del WhatsApp</label><input type="text" value="'+link+'" name="editarWhatsApp" type="tel" onkeydown="return event.keyCode !== 69"  minlength="26" maxlength="26"  oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"><label> Correo del Negocio</label><input type="email" id="email" value="'+correo+'" name="editarCorreo"><label> Dirección</label><input type="text"  style="text-transform:uppercase;" value="'+direccion+'" name="editarDireccion" id="editarUbicacion"><label id="editarUbicacion">Ubicación</label><textarea name="editarUbicacion" id="editarContenido" cols="30" rows="10">'+ubicacion+'</textarea><label> Estado</label><select name="editarEstadoNegocios" class="form-control"><option value="'+estado+'">'+estado+'</option><option value="publico">Publico</option> <option value="privado">Privado</option></select><input type="hidden" value="'+idNegocio+'" name="idNegocio"><input type="hidden" value="'+imagenNegocio+'" name="fotoAntigua"><hr></form>');
