...
$(".editarNegocio").click(function(){
	...
	direccion = $("#"+idNegocio).children("p").html();
    ubicacion = $("#"+idNegocio).children("p").html();


	
	$("#"+idNegocio).html('<form method="post" enctype="multipart/form-data"><span><input style="width:10%; padding:5px 0; margin-top:4px" type="button" class="btn btn-danger pull-right" value="Cancelar" data-dismiss="modal"  onClick="cierraNegocios()"><input style="width:10%; padding:5px 0; margin-top:4px" type="submit" class="btn btn-primary pull-right" value="Guardar"></span><div id="editarImagen"><input style="display:none" type="file" id="subirNuevaFoto" class="btn btn-default"><div id="nuevaFoto"><span class="fa fa-times cambiarImagen"></span><img src="'+imagenNegocio+'" class="img-thumbnail"></div></div><input type="text" value="'+nombreNegocio+'" name="editarNombreNegocio"><textarea cols="30" rows="5" name="editarTelefono">'+telefono+'</textarea><textarea name="editarDireccion" id="editarDireccion" cols="30" rows="10">'+direccion+'</textarea><textarea name="editarUbicacion" id="editarUbicacion" cols="30" rows="10">'+ubicacion+'</textarea><input type="hidden" value="'+idNegocio+'" name="id"><input type="hidden" value="'+imagenNegocio+'" name="fotoAntigua"><hr></form>');
