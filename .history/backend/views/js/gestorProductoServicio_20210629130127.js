...
$(".editarProductoServicio").click(function(){
	...
	<option value="">Seleccione el Rol</option><option value="0">Administrador</option></select><input type="hidden" value="'+idProductoServicio+'" name="idProductoServicio"><input type="hidden" value="'+imagenRuta+'" name="fotoAntigua"><hr></form>');
