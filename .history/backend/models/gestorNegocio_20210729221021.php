...
class GestorNegocioModel{
	...
	public function editarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET idNegocio = :idNegocio, nombreNegocio = :nombreNegocio, imagenNegocio = :imagenNegocio, telefono = :telefono, linkWhatsAppcorreo = :correo, direccion = :direccion, ubicacion = :ubicacion, estadoNegocio = :estadoNegocio WHERE idNegocio = :idNegocio");	
