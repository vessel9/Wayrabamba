...
class GestorProductoServicioModel{
	...
	public function guardarProductoServicioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombreProductoServicio, descripcion, imagenRuta, precio, cantidad, disponibles, idTipoProductoServicio, idCategoria, idNegocio) VALUES (:nombreProductoServicio, :descripcion, :imagenRuta, :precio, :cantidad, :disponibles, ÑidTipoProductoServicio, idCategoria, idNegocio)");
