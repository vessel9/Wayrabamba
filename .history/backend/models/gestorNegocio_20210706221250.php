...
class GestorNegocioModel{
	...
	public function guardarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombreNegocio, imagenNegocio, telefono, correo, direccion, ubicacion) VALUES (:nombreNegocio, :imagenNegocio, :telefono, Ñcorreo, :direccion, :ubicacion)");
