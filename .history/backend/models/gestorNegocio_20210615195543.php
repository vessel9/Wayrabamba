...
class GestorNegocioModel{
	...
	public function mostrarNegocioModel($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT 		$stmt = Conexion::conectar()->prepare("DELETE FROM $tabla WHERE idNegocio = :idNegocio");
        , titulo, introduccion, ruta, contenido FROM $tabla ORDER BY orden ASC");
