...
class GestorNegocioModel{
	...
	public function editarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET idNegocio = :idNegocio, imagenNegocio = :imagenNegocio, telefono = :telefono, direccion = :direccion, ubicacion = :ubicacion WHERE ididNegocio = :idNegocio");	
