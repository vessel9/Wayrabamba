...
class GestorCategoriasModel{
	...
	public function mostrarPruebasModel($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT id, nombre FROM $tabla ORDER BY orden ASC");
	...
	public function mostrarArticulosModel1($tabla){

		$stmt = Conexion::conectar()->prepare("SELECT idCategorianombreCategoria FROM $tabla");
