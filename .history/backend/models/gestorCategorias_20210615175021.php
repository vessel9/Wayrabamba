...
class GestorCategoriasModel{
	...
	public function mostrarCategoriasModel($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT idTipoProductoServicio, nombreCategoria FROM $tabla ORDER BY orden ASC");
	...
	public function editarCategoriasModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombreCategoria = :nombreCategoria WHERE idTipoProductoServicio = :idTipoProductoServicio");	
