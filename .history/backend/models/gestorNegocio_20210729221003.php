...
class GestorNegocioModel{
	...
	public function mostrarNegocioModel($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT idNegocio, nombreNegocio, imagenNegocio, telefono, linkWhatsAppcorreo, direccion, ubicacion, estadoNegocio FROM $tabla ORDER BY idNegocio ASC");
