...
class GestorNegocioModel{
	...
	public function guardarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombreNegocio, imagenNegocio, telefono, linkWhatsApp, correo, direccion, ubicacion, estadoNegocio) VALUES (:nombreNegocio, :imagenNegocio, :telefono, :correo, :direccion, :ubicacion, :estadoNegocio)");
