...
class GestorNegocioModel{
	...
	public function mostrarNegocioModel($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT idNegocio, nombreNegocio, imagenNegocio, telefono, direccion, ubicacion FROM $tabla ORDER BY idNegocio ASC");
	...
	public function editarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET idNegocio = :idNegocio, nombreNegocio = nombreNegocioimagenNegocio = :imagenNegocio, telefono = :telefono, direccion = :direccion, ubicacion = :ubicacion WHERE idNegocio = :idNegocio");	
