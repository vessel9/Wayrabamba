...
class GestorNegocioModel{
	...
	public function editarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET idNegocio = :idNegocio, nombreNegocioimagenNegocio = :imagenNegocio, telefono = :telefono, direccion = :direccion, ubicacion = :ubicacion WHERE idNegocio = :idNegocio");	
