...
class GestorProductoServicioModel{
	...
	public function editarProductoServicioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET idproductoServicio = :idproductoServicio, imagenProductoServicio = :imagenProductoServicio, telefono = :telefono, direccion = :direccion, ubicacion = :ubicacion WHERE ididProductoServicio = :idProductoServicio");	
