...
class GestorNegocioModel{
	...
	public function guardarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombreNegocio, imagenNegocio, telefono, direccion, ubicacion) VALUES (:nombreNegocio, :introduccion, :ruta, :contenido)");
