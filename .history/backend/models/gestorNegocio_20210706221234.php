...
class GestorNegocioModel{
	...
	public function guardarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombreNegocio, imagenNegocio, telefono, correodireccion, ubicacion) VALUES (:nombreNegocio, :imagenNegocio, :telefono, :direccion, :ubicacion)");
