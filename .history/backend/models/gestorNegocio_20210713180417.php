...
class GestorNegocioModel{
	...
	public function guardarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombreNegocio, imagenNegocio, telefono, correo, direccion, ubicacion, estadoNegocio) VALUES (:nombreNegocio, :imagenNegocio, :telefono, :correo, :direccion, :ubicacion, :estadoNegocio)");
	...
	public function mostrarNegocioModel($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT idNegocio, nombreNegocio, imagenNegocio, telefono, correo, direccion, ubicacion, estadoNegocio FROM $tabla ORDER BY idNegocio ASC");
	...
	public function editarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET idNegocio = :idNegocio, nombreNegocio = :nombreNegocio, imagenNegocio = :imagenNegocio, telefono = :telefono, correo = :correo, direccion = :direccion, ubicacion = :ubicacion, estadoNegocio = :estadoNegocio WHERE idNegocio = :idNegocio");	

		$stmt -> bindParam(":nombreNegocio", $datosModel["nombreNegocio"], PDO::PARAM_STR);
		$stmt -> bindParam(":imagenNegocio", $datosModel["imagenNegocio"], PDO::PARAM_STR);
		$stmt -> bindParam(":telefono", $datosModel["telefono"], PDO::PARAM_STR);
		$stmt -> bindParam(":correo", $datosModel["correo"], PDO::PARAM_STR);
		$stmt -> bindParam(strtoupper(":direccion", $datosModel["direccion"]), PDO::PARAM_STR);
        $stmt -> bindParam(":ubicacion", $datosModel["ubicacion"], PDO::PARAM_STR);
		$stmt -> bindParam(":estadoNegocio", $datosModel["estadoNegocio"], PDO::PARAM_STR);
