...
class GestorProductoServicioModel{
	...
	public function editarProductoServicioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombreProductoServicio = :nombreProductoServicio, descripcion, :descripcion, imagenRuta = :imagenRuta, idTipoProductoServicio = :idTipoProductoServicio, idCategoria = :idCategoria, idN = :ubicacion WHERE idproductoServicio = :idproductoServicio");	
