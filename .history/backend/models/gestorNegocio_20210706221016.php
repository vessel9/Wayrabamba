...
class GestorNegocioModel{
	...
	public function editarNegocioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET idNegocio = :idNegocio, nombreNegocio = :nombreNegocio, imagenNegocio = :imagenNegocio, telefono = :telefono, correo = :telefono direccion = :direccion, ubicacion = :ubicacion WHERE idNegocio = :idNegocio");	
