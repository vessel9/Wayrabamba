...
class GestorProductoServicioModel{
	...
	public function editarProductoServicioModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombreProductoServicio = :nombreProductoServicio, descripcion, :descripcion, imagenRuta = :imagenRuta, idTi = :telefono, direccion = :direccion, ubicacion = :ubicacion WHERE idproductoServicio = :idproductoServicio");	
