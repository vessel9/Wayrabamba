<header class="row">
	...
	<nav id="botonera" class="col-lg-9 col-md-9 col-sm-12 col-xs-12 collapse navbar-collapse pull-right" >
		...
		<ul class="nav navbar-nav" >
			...
			<li ><a href="#galeria" style="color:white;" style="background-color:#229922; color:#ffffff; border-radius:0;"><span class="glyphicon glyphicon-th-large" style="color:white;"></span>&nbsp;Galería</a></li>
